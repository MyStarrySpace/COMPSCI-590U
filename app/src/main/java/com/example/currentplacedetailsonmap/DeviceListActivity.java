...
public class DeviceListActivity extends Activity {
    ...
    /**
     * Return Button Call Back Function. Return the new devices number here by default.
     * You can also try to return the list if you want.
     */
    private void returnNewDeviceCount() {
        ...
        // Add interactions - devices and timestamp
        Date currentTime = Calendar.getInstance().getTime();
        Log.d(TAG, "Devices count: " + mNewDevicesArrayAdapter.getCount());
        for (int i = 0; i < mNewDevicesArrayAdapter.getCount(); i++){
            Pair<String, String> addPair = Pair.create(mNewDevicesArrayAdapter.getItem(i), currentTime.toString());
            g.addInteraction(addPair);
            Log.d(TAG, "Adding interaction: " + mNewDevicesArrayAdapter.getItem(i));
        }
     ...
     * If you want to keep the function of return the MAC address of the selected
